                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('clientes.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="cp" class="block mt-1 w-full" type="text" name="cp" :value="old('cp')" required />
                            <x-input-error :messages="$errors->get('cp')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="regimen_fiscal" :value="__('Régimen Fiscal')" />
                            <x-text-input id="regimen_fiscal" class="block mt-1 w-full" type="text" name="regimen_fiscal" :value="old('regimen_fiscal')" required />
